...
const destinyData: Record<string, {
  ...
  "6": {
    ...
    shadowTraits: ["「あなたのため」が口癖の世話焼き", "子供の宿題をつい手伝ってしまう過干渉", "同僚の仕事を断れず引き受けてしまう", "自分を犠牲にする自己犠牲の美化"],
  ...
  "8": {
    ...
    shadowTraits: ["仕事の成功＝人生の成功と信じ込みがち", "家族や健康を犠牲にしてしまう", "手段を選ばず成果を追う傾向", "相手を利用する行為が自分に返ってくる"],
