      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-sm leading-[2] tracking-wider">
          {[
            ...
            { title: '第3条（料金・決済）', content: '本サービスの料金体系は以下のとおりです。\n\n【都度課金プラン】\n・スタンダード鑑定：980円（税込）\n・プレミアム鑑定：2,980円（税込）\n\n【30日間メンバーシップ】\n・30日間メンバーシップ：480円（税込）\n　└ デイリー運勢配信、相性診断無制限（購入日から30日間有効）\n\n30日間メンバーシップは自動更新されません。有効期間終了後、継続をご希望の場合は再度ご購入ください。\n\n決済はクレジットカードによる即時決済とし、決済処理にはKOMOJU株式会社の決済サービスを利用します。ユーザーのクレジットカード情報は当社サーバーには保存されません。' },
