    ...
    <main className="min-h-screen bg-[#0C0A14] text-[#BEB5A5] selection:bg-[#D4AF37]/30 selection:text-white">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-[2] tracking-wider">
          {[
            { label: '販売事業者', value: '森本　大生' },
            { label: '運営統括責任者', value: '森本　大生' },
            { label: '所在地', value: '〒120-0021 東京都足立区日ノ出町35-13214号' },
            { label: '電話番号', value: '請求があった場合には遅滞なく開示いたします' },
            { label: 'メールアドレス', value: 'info@life-navigation.co.jp' },
            { label: 'サービス名', value: 'カバラ数秘術 運命鑑定' },
            { label: '販売価格', value: 'スタンダード鑑定: ¥980（税込）/ プレミアム鑑定: ¥2,980（税込）/ 月額メンバーシップ: ¥480（税込・月額）' },
            { label: '商品代金以外の必要料金', value: 'なし' },
            { label: '支払方法', value: 'クレジットカード（VISA, MasterCard, JCB, AMEX）※KOMOJU社の決済システムを利用' },
            { label: '支払時期', value: '都度課金: ご注文時に即時決済 / 月額プラン: 毎月自動更新（いつでも解約可能）' },
