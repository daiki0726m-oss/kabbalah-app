      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-sm leading-[2] tracking-wider">
          {[
            ...
            { title: '6. セキュリティ', content: '当サービスでは、個人情報の漏洩、滅失、き損等を防止するため、適切なセキュリティ対策を講じています。決済情報はPAY.JP社のPCI DSS準拠のインフラで処理され、当社サーバーに保存されることはありません。' },
